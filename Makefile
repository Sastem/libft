...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/11/05 18:16:39 by ssahai-           #+#    #+#              #
#    Updated: 2018/11/19 03:04:04 by ssahai-          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME =	libft.a

SRCS =	ft_memset.c ft_bzero.c ft_atoi.c \
		ft_isalnum.c ft_isalpha.c ft_isascii.c \
		ft_isblank.c ft_isdigit.c ft_islower.c \
		ft_isprint.c ft_isspace.c ft_isupper.c \
		ft_itoa.c ft_lstadd.c ft_lstappend.c \
		...
		ft_strlcpy.c ft_strlen.c ft_strmap.c \
